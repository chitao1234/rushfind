...
use crate::support::{argv, predicate_labels as collect_predicate_labels};
...
fn predicate_label(predicate: &RuntimePredicate) -> &'static str {
    match predicate {
        ...
        RuntimePredicate::LName(_) => "lname",
        ...
        RuntimePredicate::RelativeTime(matcher) => match (matcher.kind, matcher.unit) {
            ...
            (rushfind::time::TimestampKind::Access, rushfind::time::RelativeTimeUnit::Seconds) => {
                "atime-seconds"
            }
            (rushfind::time::TimestampKind::Change, rushfind::time::RelativeTimeUnit::Seconds) => {
                "ctime-seconds"
            }
            (
                rushfind::time::TimestampKind::Modification,
