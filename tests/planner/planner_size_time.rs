    ...
    match expr {
        ...
        RuntimeExpr::Predicate(RuntimePredicate::RelativeTime(matcher)) => {
            match (matcher.kind, matcher.unit) {
                ...
                (TimestampKind::Access, RelativeTimeUnit::Seconds) => vec!["atime-seconds"],
                (TimestampKind::Change, RelativeTimeUnit::Seconds) => vec!["ctime-seconds"],
                (TimestampKind::Modification, RelativeTimeUnit::Seconds) => vec!["mtime-seconds"],
